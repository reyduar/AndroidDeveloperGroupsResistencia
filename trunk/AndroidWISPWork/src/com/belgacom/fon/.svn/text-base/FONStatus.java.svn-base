...
import com.belgacom.fon.connectivity.ConnectivityUtis;
import com.belgacom.fon.connectivity.FonNetworkListProvider.NetworkListTable;

import static com.belgacom.fon.connectivity.FonNetworkListProvider.NEWORK_LIST_URI;
import com.belgacom.fon.connectivity.checker.InternetCheckScheduler;
...
public class FONStatus {
	...
	synchronized public static void reset(Context context) {
		Cursor networks = context.getContentResolver().query(NEWORK_LIST_URI, null, null, null, null);
	...
	synchronized public static void connectToFon(Context context,String ssid, String bssid) {		
		...
		case FON_ERROR:
			...
			context.getContentResolver().insert(NEWORK_LIST_URI, values);
