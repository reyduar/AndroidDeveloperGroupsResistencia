...
public class FonNetworkListProvider extends ContentProvider {
	private static String AUTHORITY = "com.belgacom.fon.connectivity.FonNetworkListProvider";
	...
	public static final Uri NEWORK_LIST_URI = Uri.parse("content://" + AUTHORITY + "/list");
