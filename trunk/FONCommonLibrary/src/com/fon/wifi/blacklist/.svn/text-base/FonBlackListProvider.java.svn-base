...
public class FonBlackListProvider extends ContentProvider {
	...
	private static Uri BLACK_LIST_URI ;
	...
	public static void init(String packageName){
		AUTHORITY = packageName+".FonBlackListProvider";
		uriMatcher.addURI(AUTHORITY, "black_list", MATCH_BLACK_LIST_URI);
		BLACK_LIST_URI = Uri.parse("content://" + AUTHORITY + "/black_list");
	}
	
	public static Uri getBlackListUri(){
		return BLACK_LIST_URI;
	}
